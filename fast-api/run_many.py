...
SERVERS = [
    (r"C:\dgict-teamb\fast-api\FastAPI_도서추천", "main:app", 8001),
    (r"C:\dgict-teamb\fast-api\FastAPI_도서추천", "youtube_api:app", 8004, None),
    (r"C:\dgict-teamb\fast-api\요약기능_전날브리핑", "main:app", 8005, None),
