...
SERVERS = [
    (r"C:\Dgict_TeamB_Project\fastapi22\수집_저장", "sentiment_api:app", 8001, None),
    (r"C:\Dgict_TeamB_Project\fastapi22\챗봇서비스", "chat_server2:app", 8002, None),
    (r"C:\Dgict_TeamB_Project\fastapi22\FastAPI_도서추천", "main:app", 8003, None),
    (r"C:\Dgict_TeamB_Project\fastapi22\FastAPI_도서추천", "youtube_api:app", 8004, None),
    (r"C:\Dgict_TeamB_Project\fastapi22\요약기능_전날브리핑", "main:app", 8005, None),
    (r"C:\Dgict_TeamB_Project\fastapi22\트렌드", "category_trends:app", 8006, None),
    # 예시) 다른 서비스 추가
